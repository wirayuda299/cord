...
import { getAllMembers, kickMember, banMember, Member } from "@/lib/client/api/members";
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm">
         <div className="bg-sidebar-primary border border-white/10 rounded-2xl p-6 w-full max-w-sm mx-4 flex flex-col gap-4 shadow-2xl text-white">
            <div className="flex items-center gap-3">
               ...
               <div>
                  <p className="font-semibold text-white text-sm">Ban {username}</p>
                  <p className="text-xs text-white/40 mt-0.5">Are you sure you want to ban this member?</p>
               </div>
            </div>
            <p className="text-sm text-white/60 leading-relaxed">
               Banning <span className="text-white font-medium">{username}</span> will remove them from the server and prevent them from rejoining.
            </p>
         ...
         <div className="flex flex-col h-screen text-white overflow-hidden">
            <div className="px-8 pt-8 pb-4 shrink-0 space-y-4">
               <div className="flex items-end justify-between">
                  <div>
                     <h2 className="font-bold text-xl text-[#f2f3f5]">
                        Members
                     </h2>
