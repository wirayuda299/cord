      ...
      <ConfirmDialog
         ...
         description={
            <>
               ...
               <span className="text-white font-medium">{name}</span>? They will
               be able to rejoin the server with a new invite.
            </>
         }
         confirmLabel="Unban"
         onConfirm={onConfirm}
         ...
         <div className="flex-1 min-w-0">
            ...
            <div className="flex items-center gap-3 mt-0.5 flex-wrap">
               ...
               <p className="text-xs text-white/20 shrink-0">
                  by <span className="text-white/35">{member.bannedBy}</span> ·{" "}
                  {formatDate(member.bannedAt)}
               </p>
            </div>
         </div>
            ...
            {filtered.length === 0 ? (
               ...
               <div className="flex flex-col gap-2">
                  <div className="grid grid-cols-[auto_1fr_auto] gap-4 px-5 pb-1">
                     ...
                     <p className="text-[11px] font-semibold uppercase tracking-widest text-white/25 pr-2">
                        Action
                     </p>
                  </div>
